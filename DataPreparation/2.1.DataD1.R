...
PSToRemove <- c(dir(Datapath, pattern = ".log.gz"),
                ...
                "PARTICIPANT_InstructionMarkovVideoG_2022-03-13_19h05.32.642.csv",
                "PARTICIPANT_InstructionMarkovVideoG_2022-03-10_13h55.35.879.csv",
                "PARTICIPANT_InstructionMarkovVideoG_2021-11-28_09h19.45.014.csv") # did twice d1)
...
# Remove duplicate
dRL1 = dRL1[!duplicated(dRL1$MailP1),]
